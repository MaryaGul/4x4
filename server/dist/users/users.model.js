...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'user@mail.com', description: 'Email adress' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'false', description: 'Banned or not' }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.BOOLEAN, defaultValue: false }),
    __metadata("design:type", Boolean)
], User.prototype, "banned", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '', description: 'Ban reason' }),
...
__decorate([
    (0, sequelize_typescript_1.HasMany)(() => games_model_1.Game),
    __metadata("design:type", Array)
