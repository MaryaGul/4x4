...
const Game = () => {
 ...
 const [board, setBoard] = useState(Array(16).fill(null)) // Измените размер доски на 20
 ...
 const buttonClick = (index) => {
   ...
   if (tmpwinner === null && countStep < 15) { // Измените количество ходов на 19
   ...
   if (lasttmpwinner !== null || countStep >= 15){ // Измените количество ходов на 19
     try {
 ...
 const startNewGame = () => {
   setBoard(Array(16).fill(null)) // Измените размер доски на 20
   setCount(0)
 }
 ...
 return (
   <div className='black_back'>
     ...
     <button
       ...
       onClick={() => startNewGame()}>СОБЕРИ 4!</button>
